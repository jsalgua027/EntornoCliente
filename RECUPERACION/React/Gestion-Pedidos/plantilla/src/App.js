...
const  handleMostrarPedidos =  () => { // Hacer la función async para esperar la obtención de los pedidos
...
//----------------------------------------------
  ...
  return (
    ...
    {!mostrarPedidos && !mostrarTabla && (
      <Button className='btnPedidos' color='danger' onClick={handleMostrarPedidos}>Gestionar Pedidos</Button>
    )}
  </div>
  );
}
